        ...
        <div className="sh-child-section">
           {/*  <!-- === TOP MENU ITEMS === --> */}
            <div className="sh-top-menu-items">
                <ul>
                    <li className="sh-menu-items"><L href="/manageRequisition-page">Manage Requisition</L></li>
                    <li className="sh-menu-items"><L href="/addRequisition-page">Add Requisition</L></li>
                    <li className="sh-menu-items"><L href="/managePurchase-page">Manage Purchase</L></li>
                    <li className="sh-active-item"><L href="/addPurchase-page">Add Purchase</L></li>
                    <li className="sh-menu-items"><L href="/manageReceived-page">Manage Received</L></li>
                    <li className="sh-menu-items"><L href="/managePayment-page">Manage Payment</L></li>
                </ul>
            </div>
