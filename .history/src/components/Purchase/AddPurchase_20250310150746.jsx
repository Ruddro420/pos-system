        ...
        <div className="sh-child-section">
           {/*  <!-- === TOP MENU ITEMS === --> */}
            <div className="sh-top-menu-items">
                <ul>
                    <li className="sh-menu-items"><li href="/manageRequisition-page">Manage Requisition</link></li>
                    <li className="sh-menu-items"><li href="/addRequisition-page">Add Requisition</link></li>
                    <li className="sh-menu-items"><li href="/managePurchase-page">Manage Purchase</link></li>
                    <li className="sh-active-item"><li href="/addPurchase-page">Add Purchase</link></li>
                    <li className="sh-menu-items"><li href="/manageReceived-page">Manage Received</link></li>
                    <li className="sh-menu-items"><li href="/managePayment-page">Manage Payment</link></li>
                </ul>
            </div>
