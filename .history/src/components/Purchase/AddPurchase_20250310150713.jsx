        ...
        <div className="sh-child-section">
           {/*  <!-- === TOP MENU ITEMS === --> */}
            <div className="sh-top-menu-items">
                <ul>
                    <li className="sh-menu-items"><li href="/manageRequisition-page">Manage Requisition</li></li>
                    <li className="sh-menu-items"><li href="/addRequisition-page">Add Requisition</li></li>
                    <li className="sh-menu-items"><li href="/managePurchase-page">Manage Purchase</li></li>
                    <li className="sh-active-item"><li href="/addPurchase-page">Add Purchase</li></li>
                    <li className="sh-menu-items"><li href="/manageReceived-page">Manage Received</li></li>
                    <li className="sh-menu-items"><li href="/managePayment-page">Manage Payment</li></li>
                </ul>
            </div>
