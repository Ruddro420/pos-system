        ...
        <div className="sh-child-section">
           {/*  <!-- === TOP MENU ITEMS === --> */}
            <div className="sh-top-menu-items">
                <ul>
                    <li className="sh-menu-items"><lin href="/manageRequisition-page">Manage Requisition</lin></li>
                    <li className="sh-menu-items"><lin href="/addRequisition-page">Add Requisition</lin></li>
                    <li className="sh-menu-items"><lin href="/managePurchase-page">Manage Purchase</lin></li>
                    <li className="sh-active-item"><lin href="/addPurchase-page">Add Purchase</lin></li>
                    <li className="sh-menu-items"><lin href="/manageReceived-page">Manage Received</lin></li>
                    <li className="sh-menu-items"><lin href="/managePayment-page">Manage Payment</lin></li>
                </ul>
            </div>
