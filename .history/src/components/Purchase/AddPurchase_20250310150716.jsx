        ...
        <div className="sh-child-section">
           {/*  <!-- === TOP MENU ITEMS === --> */}
            <div className="sh-top-menu-items">
                <ul>
                    <li className="sh-menu-items"><lik href="/manageRequisition-page">Manage Requisition</lik></li>
                    <li className="sh-menu-items"><lik href="/addRequisition-page">Add Requisition</lik></li>
                    <li className="sh-menu-items"><lik href="/managePurchase-page">Manage Purchase</lik></li>
                    <li className="sh-active-item"><lik href="/addPurchase-page">Add Purchase</lik></li>
                    <li className="sh-menu-items"><lik href="/manageReceived-page">Manage Received</lik></li>
                    <li className="sh-menu-items"><lik href="/managePayment-page">Manage Payment</lik></li>
                </ul>
            </div>
