        ...
        <div className="sh-child-section">
           {/*  <!-- === TOP MENU ITEMS === --> */}
            <div className="sh-top-menu-items">
                <ul>
                    <li className="sh-menu-items"><L href="/manageRequisition-page">Manage Requisition</link></li>
                    <li className="sh-menu-items"><L href="/addRequisition-page">Add Requisition</link></li>
                    <li className="sh-menu-items"><L href="/managePurchase-page">Manage Purchase</link></li>
                    <li className="sh-active-item"><L href="/addPurchase-page">Add Purchase</link></li>
                    <li className="sh-menu-items"><L href="/manageReceived-page">Manage Received</link></li>
                    <li className="sh-menu-items"><L href="/managePayment-page">Manage Payment</link></li>
                </ul>
            </div>
