        ...
        <div className="sh-child-section">
           {/*  <!-- === TOP MENU ITEMS === --> */}
            <div className="sh-top-menu-items">
                <ul>
                    <li className="sh-menu-items">< href="/manageRequisition-page">Manage Requisition</></li>
                    <li className="sh-menu-items">< href="/addRequisition-page">Add Requisition</></li>
                    <li className="sh-menu-items">< href="/managePurchase-page">Manage Purchase</></li>
                    <li className="sh-active-item">< href="/addPurchase-page">Add Purchase</></li>
                    <li className="sh-menu-items">< href="/manageReceived-page">Manage Received</></li>
                    <li className="sh-menu-items">< href="/managePayment-page">Manage Payment</></li>
                </ul>
            </div>
