          ...
          <div className="sh-top-menu-items">
            <ul>
              <li className="sh-menu-items">
                <a href="/addRequisition-page">Add Requisition</a>
              </li>
              <li className="sh-menu-items">
                <a href="/addRequisition-page">Manage Requisition</a>
              </li>
              <li className="sh-menu-items">
                <a href="/addPurchase-page">Add Purchase</a>
              </li>
              <li className="sh-menu-items">
                <a href="/managePurchase-page">Manage Purchase</a>
              </li>
              <li className="sh-menu-items">
                <a href="/manageReceived-page">Manage Received</a>
              </li>
              <li className="sh-active-item">
                <a href="/managePayment-page">Manage Payment</a>
              </li>
            </ul>
          </div>
...
export default SelsManagePayment;
