    ...
    return (
      ...
      {/*   <!-- === TOP MENU ITEMS === --> */}
        <div className="sh-top-menu-items">
            <ul>
                <li className="sh-active-item"><a href="financial-reports.html">Cash Book</a></li>
                <li className="sh-menu-items"><a href="bank-book.html">Bank Book</a></li>
                <li className="sh-menu-items"><a href="general-ledger.html">General Ledger</a></li>
                <li className="sh-menu-items"><a href="trial-balance.html">Trial Balance</a></li>
                <li className="sh-menu-items"><a href="profit-loss.html">Profit & Loss</a></li>
