...
const SalesReport = () => {
    ...
    <div className="sh-top-menu-items">
        <ul>
            <li className="sh-active-item"><a href="sales-report.html">Counter Wise Sales Report</a></li>
            <li className="sh-menu-items"><a href="sales-report-outlet.html">Outlet Wise Sales Report</a></li>
        </ul>
    </div>
    {/* <!-- === COUNTER SECTION === --> */}
