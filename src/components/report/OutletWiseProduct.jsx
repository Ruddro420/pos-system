 ...
 {/*    <!-- === TOP MENU ITEMS === --> */}
    <div className="sh-top-menu-items">
        <ul>
            ...
            <li className="sh-active-item"><Link to="/OutletWiseProduct-page">Outlet Wise Product</Link></li>
            <li className="sh-menu-items"><Link to="/OutletWiseVariantProduct-page">Outlet Wise Variant Product</Link></li>
        </ul>
    </div>
   {/*  <!-- === PARENT CONTAINER === --> */}
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Opening <br/> Qty.<span>
                                    <p>(+)</p>
                                </span></th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Received <br/> Qty. (Purchase) <span>
                                    <p>(+)</p>
                                </span></th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Delivered <br/> Qty. <br/> (Sale) <br/>
                                <span> (-)</span></th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Pur. <br/> Return <br/> Qty. <br/>
                                <span>(-)</span></th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Sale <br/> Ret <br/> Qty<span>
                                    <p>(+)</p>
                                </span></th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Wastage <br/> Qty. <br/><span>(-)</span>
                            </th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Adjustment <br/> Qty.<span>
                                    <p>(+)</p>
                                </span></th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Transfer <br/> Qty<span>
                                    <p>(-)</p>
                                </span></th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Transfer <br/> Rec. Qty.<span>
                                    <p>(+)</p>
                                </span></th>
