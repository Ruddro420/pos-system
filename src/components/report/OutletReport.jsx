...
const OutletReport = () => {
    return (
        ...
        <ul>
            <li className="sh-active-item"><Link  to="/OutletReport-page">Outlet Wise Report</Link></li>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Received Qty. <br/> (Purchase) <span><p>(+)</p></span></th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Delivered <br/> Qty. (Sale) <span>(-)</span></th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Pur. <br/> Return <br/> Qty. <span>(-)</span></th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Sale <br/> Ret. <br/> Qty.<span><p>(+)</p></span></th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Wastage <br/> Qty<span>(-)</span></th>
                            <th className="sh-text-right" rowSpan="1" colSpan="1">Adjustment <br/> Qty.<span>(-)</span></th>
                    ...
                    <tbody>
                        <tr>
                            <td>01</td>
                            <td className="sh-text-center">Default <br/> Outlet</td>
                            <td className="sh-text-right">0</td>
                            <td className="sh-text-right">0</td>
                            <td className="sh-text-right">0</td>
                            <td className="sh-text-right">0</td>
                            <td className="sh-text-right">0.000</td>
                            <td className="sh-text-right">0.000</td>
                            <td className="sh-text-right">0.000</td>
                            <td className="sh-text-right">0.000</td>
                            <td className="sh-text-right">0.000</td>
