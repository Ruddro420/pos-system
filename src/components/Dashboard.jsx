    ...
    <>
      <nav>
        ...
        <div className="dashboard-top-title">
          ...
          {/* === DASHBOARD TOP TITLE RIGHT ITEMS === */}
        ...
        <div className="total-reviews-section">
          ...
          <div className="review-container">
            <img src="/public/dashboard/today-sale.svg" alt="Today Sale" />
          ...
          <div className="review-container">
            <img
              src="/public/dashboard/tota-productl-sale.svg"
              alt="Total Product Sale"
            />
            <div className="review-text">
          ...
          <div className="review-container">
            <img
              src="/public/dashboard/today-purchase.svg"
              alt="Total Purchase"
            />
            <div className="review-text">
              <p>Total Purchase</p>
        ...
        <div className="total-reviews-section">
          ...
          <div className="review-container">
            <img
              src="/public/dashboard/total-expense.svg"
              alt="Total Product Sale"
            />
            <div className="review-text">
              <p>Total Expenses</p>
          ...
          <div className="seles-section">
            <div className="seles-text">
              ...
              <div className="sales-calendar">
                <img src="/public/dashboard/calendar icon.svg" alt="Calendar" />
                <input type="date" />
                <input type="date" />
              </div>
            </div>
            ...
            <div className="sales-menu-icon">
              <img src="/public/dashboard/menu icon.svg" alt="Menu" />
            </div>
            {/* === SALES GRAPH IMAGE === */}
            <div className="sales-graph-image">
              <img src="/public/dashboard/sales graph.svg" alt="Sales Graph" />
            </div>
          </div>
        ...
        <div className="sales-and-inventory-graph-section">
          ...
          <div className="seles-section">
            ...
            <div className="sales-graph-image">
              <img
                src="/public/dashboard/15 days graph.svg"
                alt="15 Days Graph"
              />
            </div>
          </div>
        ...
        <div className="financial-section">
          ...
          <div className="financial-icons">
            <img src="/public/dashboard/plus icon.svg" alt="Plus" />
            <img src="/public/dashboard/minus icon.svg" alt="Minus" />
            <img src="/public/dashboard/plus search icon.svg" alt="Search" />
            <img src="/public/dashboard/hand icon.svg" alt="Hand" />
            <img src="/public/dashboard/home icon.svg" alt="Home" />
            <img src="/public/dashboard/menu icon.svg" alt="Menu" />
          </div>
          {/* === FINANCIAL GRAPH IMAGE === */}
          <div className="financial-graph-image">
            <img
              src="/public/dashboard/financial graph-png.png"
              alt="Financial Graph"
            />
          </div>
        </div>
