                ...
                <div className="pricing-cart-container">
                    <div className="pricing-cart">
                        <div className="pricing-cart-header">
                            <img src="/img/home.png" alt="starter plan"/>
                                <h3>Basic</h3>
                                <div className="pricing">
                                    <span className="money-sign">৳</span>
                                    <h2>900</h2>
                                    <span className="package-v">/mo</span>
                                    <span className="regular-price">৳<s>1,500</s></span>
                                </div>
                        </div>
                        ...
                        <div className="features-list-two">
                            <ul>
                                ...
                                <li><i className='flt-icon-i bx bx-x'></i>Service</li>
                                <li><i className='flt-icon-i bx bx-x'></i>Delivery</li>
                                <li><i className='flt-icon-i bx bx-x'></i>Accounts</li>
                                <li><i className='flt-icon-a bx bx-check'></i>Purchase</li>
                                <li><i className='flt-icon-i bx bx-x'></i>Activity Log</li>
                    ...
                    <div className="pricing-cart">
                        <div className="pricing-cart-header">
                            <img src="/img/briefcase.png" alt="starter plan"/>
                                <h3>Starter</h3>
                                <div className="pricing">
                                    <span className="money-sign">৳</span>
                                    <h2>2499</h2>
                    ...
                    <div className="pricing-cart pricing-cart-premium">
                        <div className="pricing-cart-header">
                            <img src="/img/premium-quality.png" alt="starter plan"/>
                                <h3>Premium</h3>
                                <div className="pricing">
                                    <span className="money-sign">৳</span>
                                    <h2>3399</h2>
                    ...
                    <div className="pricing-cart">
                        <div className="pricing-cart-header">
                            <img src="/img/grocery-store.png" alt="starter plan"/>
                                <h3>Enterprise</h3>
                                <div className="pricing">
                                    <span className="money-sign">৳</span>
                                    <h2>5000</h2>
